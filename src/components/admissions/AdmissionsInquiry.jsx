...
const AdmissionsInquiry = () => {
    ...
    return (
        <section className="academics-section reveal-on-scroll" id="inquiry-form">
            ...
            <div className="level-card" style={{ maxWidth: '700px', margin: '2rem auto', padding: '3rem' }}>
                <form onSubmit={handleSubmit} style={{ display: 'grid', gap: '1.5rem' }}>
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                        <div className="form-group">
                            <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>{t('admissions:form.parent_info')}</label>
                            <input
                                type="text"
                                required
                        ...
                        <div className="form-group">
                            <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>{t('admissions:form.email_address')}</label>
                            <input
                                type="email"
                                required
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.5rem' }}>
                        <div className="form-group">
                            <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>{t('admissions:form.phone_number')}</label>
                            <input
                                type="tel"
                        ...
                        <div className="form-group">
                            <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>{t('admissions:inquiry.intended_level')}</label>
                            <select
                                required
                                value={formData.student_level}
                                onChange={e => setFormData({ ...formData, student_level: e.target.value })}
                                style={{ width: '100%', padding: '0.85rem', borderRadius: '12px', border: '1px solid #e2e8f0', outline: 'none', background: 'white' }}
                            >
                    ...
                    <div className="form-group">
                        <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>{t('admissions:inquiry.message_label')}</label>
                        <textarea
                            value={formData.message}
                            onChange={e => setFormData({ ...formData, message: e.target.value })}
                            style={{ width: '100%', padding: '0.85rem', borderRadius: '12px', border: '1px solid #e2e8f0', outline: 'none', minHeight: '120px' }}
