import{s as r}from"./index-BwtYp3Ig.js";const a=async({to:s,subject:i,html:t})=>{try{const{data:e,error:o}=await r.functions.invoke("send-email",{body:{to:s,subject:i,html:t}});if(o)throw console.error("Supabase function error:",o),o;return console.log("✅ Email sent successfully:",e),{success:!0,data:e}}catch(e){return console.error("❌ Email sending failed:",e),{success:!1,error:e.message}}},c=async s=>{const{parent_name:i,parent_email:t,student_name:e,class_applying_for:o}=s,n=`
<!DOCTYPE html>
<html>
<head>
    <style>
