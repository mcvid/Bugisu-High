import{r as Oe,R as jm}from"./index-DnZapYtk.js";function oc(i,t){(t==null||t>i.length)&&(t=i.length);for(var e=0,n=Array(t);e<t;e++)n[e]=i[e];return n}function Zm(i){if(Array.isArray(i))return i}function Km(i,t,e){return(t=eg(t))in i?Object.defineProperty(i,t,{value:e,enumerable:!0,configurable:!0,writable:!0}):i[t]=e,i}function Jm(i,t){var e=i==null?null:typeof Symbol<"u"&&i[Symbol.iterator]||i["@@iterator"];if(e!=null){var n,s,r,o,a=[],h=!0,l=!1;try{if(r=(e=e.call(i)).next,t===0){if(Object(e)!==e)return;h=!1}else for(;!(h=(n=r.call(e)).done)&&(a.push(n.value),a.length!==t);h=!0);}catch(c){l=!0,s=c}finally{try{if(!h&&e.return!=null&&(o=e.return(),Object(o)!==o))return}finally{if(l)throw s}}return a}}function Qm(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
